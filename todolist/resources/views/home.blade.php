...
<body>
      <div class="container-fluid py-4">
          ...
          <form id="ajax-form" action="{{ route('InserirTarefa') }}">
            @csrf
            ...
            <div class="container-fluid">
              ...
              <div class="header">
                ...
                <div class="row">
                    ...
                    <button class=" fs-4 col-sm-5"><i class='bx bxs-trash-alt'></i> Remover todas tarefas</button>
                </div>
              </div>
              <hr/>
              <br />
              <div class="divInsert">
                ...
                <input class="textInsert form-control" type="text" placeholder="Inserir nova tarefa"/>
